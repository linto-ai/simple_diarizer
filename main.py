...
parser.add_argument("--number_of_speakers", dest='number_of_speaker', default=None, type=int)
parser.add_argument("--max_speakers", dest='max_speakers', default=25, type=int)
